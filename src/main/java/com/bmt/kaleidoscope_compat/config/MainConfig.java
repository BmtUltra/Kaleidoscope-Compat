...
public class MainConfig {
    ...
    private static final ForgeConfigSpec.EnumValue<DatapackMode> DATAPACK_MODE = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue SOUP_DATAPACK_ENABLED = BUILDER
            .comment("Enable soup base material", "是否启用汤锅材质拓展")
            .define("datapack.soup_enabled", true);

    private static final ForgeConfigSpec.BooleanValue LUNCH_BAG_BLACKLIST_ENABLED = BUILDER
            .comment("Whether the lunch bag blacklist is enabled","是否启用嬗变饭袋物品黑名单")
            .define("lunchBlacklist.blacklist_enabled", true);

    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> LUNCH_BAG_BLACKLIST = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue SATIATED_SHIELD_WEAKEN_ENABLED = BUILDER
    ...
    private static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_DAMAGE_REDUCTION_RATIO = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue NOURISHMENT_EFFECT_BLOCK_ENABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue TRANSMUTATION_LUNCH_BAG_BACK_ENABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue COOKING_POT_RECIPES_DISABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue CUTTING_BOARD_RECIPES_DISABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue FARM_AND_CHARM_COOKING_POT_RECIPES_DISABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue VINERY_BARREL_RECIPES_DISABLED = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue SCARECROW_REPEL_PHANTOMS = BUILDER
